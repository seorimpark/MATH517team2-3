...
Thus, temperature has a statistically significant effect on the hazard ratio for wildfire events.The analysis was also repeated for other years: the resulting hazard ratio estimates have been illustrated with $95\%$ confidence intervals  in Fig. \@ref(fig:HR) below.
